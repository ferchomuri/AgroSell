import 'package:agrosell/features/features/widgets/components/info_card.dart';
import 'package:agrosell/features/features/widgets/components/list_fruit.dart';
  ...
  Widget build(BuildContext context) {
    final features = [
      InfoCard(
        title: 'CRUD',
        content:
            'En este widget se puede accerder a una lista creada en firestore',
        icon: null,
        widget: const ListFruit(
          title: 'Test',
        ),
      ),
      // InfoCard(
